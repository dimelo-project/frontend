<template>
  <div class="flex justify-center">
    <div class="txt-sub mb-96" style="width: 990px">
      <p class="text-center txt-mid-bold mt-14">디멜로 서비스 이용약관</p>
      <p class="txt-sub-bold mt-14">제 1 장 총칙</p>
      <br />
      <br />
      <p>제 1 조 (목적)</p>
      <p>
        본 약관은 디멜로가 운영하는 웹 사이트 (http://xxx.xxx.xxx)의 제반
      ...
      <p class="txt-sub-bold">제 2 장 이용계약</p>
      <br />
      <p>제 5 조 (이용신청)</p>
      <p>
      ...
      <p>
        ②이용신청자는 반드시 실제 정보를 사용해야 하며 1개의 이메일 주소에
        대하여 1건의 이용신청을 할 수 있다.
      </p>
      <p>
        ③실제 정보를 입력하지 않은 이용자는 법적인 보호를 받을 수 없으며, 서비스
        이용에 제한을 받을 수 있다.
      </p>
      <br />
      <p>제 6 조 (이용신청의 승낙)</p>
      ...
      <p class="txt-sub-bold">제 3 장 계약 당사자의 의무</p>
      <br />
      <p>제 7 조 (회사의 의무)</p>
      ...
      <p>
        ②이용자는 회사의 사전 승인 없이 본 사이트를 이용해 어떠한 영리행위도 할
        수 없다.
      </p>
      <p>
      ...
      <br />
      <p class="txt-sub-bold">제 4 장 서비스의 제공 및 이용</p>
      <br />
      <p>제 9 조 (서비스 이용)</p>
      ...
      <br />
      <p class="txt-sub-bold">제 5 장 기타</p>
      <br />
