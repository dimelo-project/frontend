      ...
      <div>
        ...
        <div class="flex justify-between mt-7.5" style="width: 376px">
          <div
            ...
            :class="[
              i === $store.state.multiStepModal.q4score
                ? 'bg-orange2 text-white'
                : 'bg-gray4 text-gray1',
            ]"
            style="width: 56px; height: 56px"
            @click="$store.commit('multiStepModal/changeQ4score', i)"
          >
...
export default {
  computed: {
    nextBtnActive() {
      return this.$store.state.multiStepModal.q4score ? true : false;
    },
  },
};
</script>
